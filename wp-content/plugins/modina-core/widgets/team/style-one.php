<div class="row">
    ...
    <div class="col-xl-3 col-md-6 col-12">
        <div class="team-member-card bg-cover <?php if( !empty( $item['member_active'] ) && $item['member_active'] == 'yes' ) : ?> active <?php endif; ?>" style="background-image: url('<?php echo esc_url($item['member_img']['url']); ?>')">
            <div class="profile-info-card">
                <span><?php echo esc_html($item['member_post']) ?></span>
                <h5><?php echo esc_html($item['member_name']) ?></h5>
