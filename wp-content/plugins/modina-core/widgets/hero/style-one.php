                ...
                <div class="row">
                    <div class="col-12 col-lg-10 col-xl-10">
                        <div class="hero-contents">
                            ...
                            <h3 class="animated-text small-heading"><?php echo htmlspecialchars_decode(esc_html($item['hero_subtitle'])); ?></h3>
                            <?php endif; ?>
                            ...
                            <a href="<?php echo esc_url($item['btn_link2']['url']); ?>" <?php modina_is_external($item['btn_link2']); ?> <?php modina_is_nofollow($item['btn_link2']); ?> class="theme-btn animated-text animated-btn black"><?php echo esc_html( $item['button_text2'] ); ?></a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
